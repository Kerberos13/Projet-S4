...
"""
def use_CNN(dataMatrix,params_file='scripts/parametres_V3/CNN/params_BdV2.5_mixed_50_37_BW_compatible.pkl',nkerns=[10, 15]):#scripts/params_BdV2.5_mixed_50_37_BW_compatible.pkl'#'scripts/params_mixed_5types_CPU.pkl'
