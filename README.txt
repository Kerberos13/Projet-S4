...
integrated for Python2 though), numpy, Pillow. If you try to run it without installing the dependancies, an error message should 
appear and invite you to run the setup.py script. Please note that you should run this setup script with root privileges.
