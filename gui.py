...
class Interface(Frame) :
    ...
    def __init__(self, window, **kwargs) :
        ...
        self.Oquit_button.grid(row=6,column=5)


        self.Ocompute_button = Button(self, text="Compute", command=self.compute)
        self.Ocompute_button.grid(row=5,column=5)
        ...
        self.Lfile.grid(row=2,column=3)
        #self.Ofile = Listbox(self)
        self.Ofile = Combobox(self)
        self.Ofile.grid(row=3,column=3)
        """
        ...
        self.console = ""
        self.Oconsole = Label(self,text=self.console)
        self.Oconsole.grid(row=5,column=3)
    ...
    def printConsole(self,text) :
        self.Oconsole.config(text=str(self.console+"<$> "+text+"\n"))
        return
